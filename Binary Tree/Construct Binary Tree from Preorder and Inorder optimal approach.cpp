...
int main()
{
    cout << "Testing Optimized Binary Tree Construction from Preorder and Inorder:\n\n";
    ...
    for (int x : inorder1)
        cout << x << " ";
    Solution sol1;
    TreeNode *root1 = sol1.buildTree(preorder1, inorder1);
    cout << "\nBuilt Tree Preorder: ";
    printPreorder(root1);
    cout << "\nBuilt Tree Inorder:  ";
    printInorder(root1);
    ...
    // Test Case 4: Larger balanced tree
    cout << "Test Case 4: Larger balanced tree\n";
    vector<int> preorder4 = {1, 2, 4, 8, 9, 5, 10, 11, 3, 6, 12, 13, 7, 14, 15};
    vector<int> inorder4 = {8, 4, 9, 2, 10, 5, 11, 1, 12, 6, 13, 3, 14, 7, 15};
    cout << "Input Preorder: ";
    for (int x : preorder4)
        cout << x << " ";
    cout << "\nInput Inorder:  ";
    ...
    // Test Case 5: Simple balanced tree
    cout << "Test Case 5: Simple balanced tree\n";
    ...
    for (int x : inorder5)
        cout << x << " ";
    Solution sol5;
    TreeNode *root5 = sol5.buildTree(preorder5, inorder5);
    cout << "\nBuilt Tree Preorder: ";
    printPreorder(root5);
    cout << "\nBuilt Tree Inorder:  ";
    printInorder(root5);
    ...
    cout << "Note: This optimized approach uses HashMap for O(1) index lookup instead of O(n) linear search.\n";
    cout << "Time Complexity: O(n) instead of O(n²)\n";
